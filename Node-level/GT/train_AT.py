...
if __name__ == '__main__':
    ...
    new_outputs, new_graph_repr, new_att = GT_AT(torch.cat((features, feats_delta), dim=0), adj_delta)
    ...
    fidelity_pos_list, fidelity_neg_list = compute_fidelity(GT_AT, adj, features, label, test_idx, avg_att)
