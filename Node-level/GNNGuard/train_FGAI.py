...
if __name__ == '__main__':
    ...
    # ==================================================================================================
    tim = '_02-08'
    vanilla_model.load_state_dict(torch.load(f'./GNNGuard_checkpoints/{dataset}{tim}/model_parameters.pth'))
    ...
    # 8. Evaluation
    # ==================================================================================================
    adj_perturbed = sp.load_npz(f'./GNNGuard_checkpoints/{args.dataset}{tim}/adj_delta.npz')
    feats_perturbed = torch.load(f'./GNNGuard_checkpoints/{args.dataset}{tim}/feats_delta.pth').to(device)
