...
class PGD(InjectionAttack):
    ...
    def attack(self, model, adj, features, target_mask, adj_norm_func, mode='Injection Attack'):
        if mode == 'Injection Attack':
        ...
        elif mode == 'Modification Attack':
            adj_attack, features_attack = self.modification(model, adj, features, target_mask, adj_norm_func)
            pass
    ...
    def modification(self, model, adj, features, target_mask, adj_norm_func):
